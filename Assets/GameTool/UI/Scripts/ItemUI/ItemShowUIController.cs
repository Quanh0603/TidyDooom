...
namespace GameTool.UI.Scripts.ItemUI
{
    public class ItemShowUIController : BasePooling
    {
        ...
        public void SetItemType(ItemResourceType itemResourceType)
        {
            ...
            ItemResourceInfo info =
                AddItemEffectManager.Instance.itemResourceData.GetItemResourceInfo(this.itemResourceType);
        ...
        {
            get { return rectTrans.anchoredPosition3D; }
            set { rectTrans.anchoredPosition3D = value; }
        }
