    ...
    public class TextData : MonoBehaviour
    {
        ...
        void UpdateText()
        {
            switch (textType)
            {
                case TextType.Coin:
                    txtOut.text =
                        AbbrevationUtility.AbbreviateNumber(GameToolSample.GameDataScripts.Scripts.GameData.Instance
                            .CoinFake);
                    break;
                case TextType.Diamond:
                    ...
                    break;
                case TextType.Level:
                    txtOut.text = String.Format("Level: {0}",
                        GameToolSample.GameDataScripts.Scripts.GameData.Instance.CurrentLevel);
                    break;
            }
        }
    }
