...
namespace GameTool.SpineAnimation.Editor
{
    public class SpineToolStyle
    {
        ...
        {
            normal = new GUIStyleState { textColor = GetColor("#7a7a7a") }, alignment = TextAnchor.MiddleRight,
            margin = new RectOffset(5, 5, 0, 0)
        };

        public static readonly GUIStyle AnimName = new GUIStyle()
        {
            normal = new GUIStyleState { textColor = Color.white }, alignment = TextAnchor.MiddleLeft,
