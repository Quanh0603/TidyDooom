...
namespace GameTool.Assistants.ParticleSystemPreview.Editor
{
    public class ParticleSystemPreview : ObjectPreview
    {
        ...
        private void DoRenderPreview()
        {
            ...
            PositionPreviewObjects(pivotRot, pivotPos, quaternion2, bodyPos, directionRot, quaternion, vector,
            ...
            floorMaterial.mainTextureOffset =
                -new Vector2(position.x, position.z) * (5f * 0.08f * (1f / m_AvatarScale));
        ...
        {
            m_PreviewDir -= evt.delta * ((!evt.shift) ? 1 : 3) / Mathf.Min(previewRect.width, previewRect.height) *
                            140f;
