...
namespace GameTool.Assistants.DesignPattern
{
    public static class EventDispatcher
    {
        ...
        /// Store all "listener"
        static Dictionary<EventID, List<Action<Component, object[]>>> _listenersDict =
    ...
    public static class EventDispatcherExtension
    {
        ...
        public static void RegisterListener(this MonoBehaviour sender, EventID eventID,
            Action<Component, object[]> callback)
        {
