...
namespace DevUlts.DateTimeScripts
{
    /// <summary>
    ...
    public class DateTimeManager : SingletonMonoBehaviour<DateTimeManager>
    {
        ...
        [Tooltip("Thời gian tối đa để request, tính bằng Milisecond")] [SerializeField]
        private int _timeOutPerRequest = 500;
        ...
        private void RequestTimeNTP(int protectKey)
        {
            ...
            Task.Run(() =>
            {
                ...
                _callbackProtector.CallNonProtect(() => OnDoneRequest(false, getted, netDateTime, ntpServer),
                    protectKey);
            });
        }
