...
namespace DevUlts.UI_Utility
{
    public class FollowSafeArea : MonoBehaviour
    {
        [Tooltip(
            "RectTrsf cầm safe area, stretch toàn màn hình, cùng cấp với this rect (this rect, _rectFull cũng phải thế)")]
        [SerializeField]
        private RectTransform _rectSafe;

        [Tooltip("Xem tooltip Rect Safe")] [SerializeField]
        private RectTransform _rectFull;
